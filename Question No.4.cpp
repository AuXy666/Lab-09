...
public:
    ...
    void AVL_union(node* temp1, node* temp2)
    {
        if (temp2 == NULL)
        {
            return;
        }
        root = insert(temp1, temp2->val);
        AVL_union(temp1, temp2->left);
        AVL_union(temp1, temp2->right);
...
int main()
{
    ...
    while (loopCounter)
    {
        cout << "Press 1 to insert into first AVL Tree" << endl;
        cout << "Press 2 to insert into second AVL Tree" << endl;
        cout << "Press 3 to Take Union of them" << endl;
        ...
        else if (loopInput == 2)
        {
            cout << "Enter Value" << endl;
            cin >> value;
            a2.root = a2.insert(a2.root, value);
        }
        else if (loopInput == 3)
        {
            a1.AVL_union(a1.root, a2.root);
            cout << endl;
            cout << "Union Taken Successfully" << endl;
            cout << endl;
